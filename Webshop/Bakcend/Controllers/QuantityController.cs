...
namespace Bakcend.Controllers
{
    ...
    public class QuantityController : ControllerBase
    {
        ...
        public ActionResult Post(CreateQuantityDto createQuantityDto )
        {
            ...
            {
                Extant = createQuantityDto.Extant,
                Sold = createQuantityDto.Sold,
                Revenue = createQuantityDto.Revenue
            };
        ...
        public ActionResult Put(int id, UpdateQuantityDto updateQuantityDto)
        {
            using (var context = new WebshopContext())
            {
                ...
                if (existingquantity != null)
                {
                    ...
                    existingquantity.Extant = updateQuantityDto.Extant;
                    existingquantity.Sold = updateQuantityDto.Sold;
                    existingquantity.Revenue = updateQuantityDto.Revenue;
